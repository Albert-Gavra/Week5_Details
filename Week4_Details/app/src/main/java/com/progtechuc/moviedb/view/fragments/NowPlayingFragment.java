        ...
        public void onChanged(NowPlaying nowPlaying) {
            ...
            ItemClickSupport.addTo(rv_now_playing).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                ...
                public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                    ...
                    bundle.putString("movieDate", ""+ nowPlaying.getResults().get(position).getRelease_date());
                    bundle.putString("movieDescription", ""+ nowPlaying.getResults().get(position).getOverview());
                    bundle.putString("movieVote", "" + nowPlaying.getResults().get(position).getVote_count());
                    bundle.putString("movieAvg", "" + nowPlaying.getResults().get(position).getVote_average());
                    bundle.putString("moviePopularity", "" + nowPlaying.getResults().get(position).getPopularity());
