        ...
        public void onChanged(UpComing upComing) {
            ...
            ItemClickSupport.addTo(rv_up_coming).setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                ...
                public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                    ...
                    bundle.putString("movieTitle", ""+ upComing.getResults().get(position).getTitle());
                    bundle.putString("movieDate", ""+ upComing.getResults().get(position).getRelease_date());
                    bundle.putString("movieDescription", ""+ upComing.getResults().get(position).getOverview());
                    bundle.putString("movieVote", "" + upComing.getResults().get(position).getVote_count());
                    bundle.putString("movieAvg", "" + upComing.getResults().get(position).getVote_average());
                    bundle.putString("moviePopularity", "" + upComing.getResults().get(position).getPopularity());
